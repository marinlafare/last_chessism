...
from chessism_api.routers import players, games, fens, analysis, jobs, analysis_times
...
app.include_router(analysis_times.router, prefix="/analysis_times", tags=["Analysis Times"])
